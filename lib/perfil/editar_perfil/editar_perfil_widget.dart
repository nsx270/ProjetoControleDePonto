                                    ...
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'if1a9uhj' /* Alterar foto de perfil */,
                                            ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'kegg0l7e' /* Alterar suas informações */,
                      ),
                      style:
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'v5sxwtm0' /* Informações de pagamento */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
