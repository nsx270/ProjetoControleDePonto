...
import 'pesquisador_model.dart';
export 'pesquisador_model.dart';

class PesquisadorWidget extends StatefulWidget {
  const PesquisadorWidget({super.key});

  static String routeName = 'Pesquisador';
  static String routePath = '/pesquisador';

  @override
  State<PesquisadorWidget> createState() => _PesquisadorWidgetState();
}

class _PesquisadorWidgetState extends State<PesquisadorWidget>
    with TickerProviderStateMixin {
  late PesquisadorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PesquisadorModel());
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                          'njcb48zb' /* Pesquise por um profissional */,
                        ),
                        labelStyle:
                                      ...
                                      children: [
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/360_F_276663862_0G8mZeliu4o34DodicCBAx576Q6JpKtg.jpg',
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      children: [
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/depositphotos_39307617-stock-photo-man-giving-thumbs-up-at.jpg',
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      children: [
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/istockphoto-1049775258-612x612.jpg',
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'q6j5oqcj' /* Técnico de informática */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
