                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '7mrq3i27' /* Insira informações sobre a tar... */,
                                      ),
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '9nw5ivs5' /* Selecione os dias que tenha di... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
