                                            ...
                                            Padding(
                                              ...
                                              child: AutoSizeText(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'ypoft0qg' /* Insira seus dados pessoais */,
                                                ),
                                                style:
                                            ...
                                            Padding(
                                              ...
                                              child:
                                                ...
                                                options: [
                                                  ...
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'z5tl1esm' /* Prefiro não responder */,
                                                  )
                                                ],
                                                onChanged: (val) =>
                                                    safeSetState(() =>
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            ...
                                            options: [
                                              ...
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'qhb8cjnt' /* Distrito Federal */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'kwvg9a4j' /* Espírito Santo */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'jay4jr8n' /* Goiás */,
                                              ...
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'a0k8gz26' /* Mato Grosso */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'k88nlrn2' /* Mato Grosso do Sul */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'jqwxoxep' /* Minas Gerais */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '56r2wzqh' /* Pará */,
                                              ...
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'qpave7re' /* Rio  de Janeiro */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '6povw4v7' /* Rio Grande do Norte */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'o3yjcjma' /* Rio Grande do Sul */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '84s5dgym' /* Rondônia */,
                                                      ...
                                                      children: [
                                                        TextSpan(
                                                          text: FFLocalizations
                                                                  .of(context)
                                                              .getText(
                                                            'y16jj99b' /* Declaro que li concordo com os... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
