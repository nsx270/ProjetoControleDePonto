...
class _RegistrarWidgetState extends State<RegistrarWidget> {
  ...
  void initState() {
    ...
    _model.verificarEmailTextController ??= TextEditingController();
    _model.verificarEmailFocusNode ??= FocusNode();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'na861rhd' /* Utilize seu email e crie uma s... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .verificarEmailTextController,
                                          focusNode:
                                              _model.verificarEmailFocusNode,
                                          autofocus: true,
                                          autofillHints: [AutofillHints.email],
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '7wbhq5qe' /* Já possuí uma conta na HELP?  */,
                                                ),
                                                style: TextStyle(),
                                              ),
                                              TextSpan(
