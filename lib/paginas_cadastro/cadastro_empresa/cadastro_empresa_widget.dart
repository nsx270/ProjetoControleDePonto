...
class CadastroEmpresaWidget extends StatefulWidget {
  ...
  static String routeName = 'CadastroEmpresa';
  static String routePath = '/cadastroEmpresa';
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: AutoSizeText(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'juc6f49a' /* Insira os dados da sua empresa */,
                                                      ),
                                              ...
                                              Padding(
                                                ...
                                                child:
                                                  ...
                                                  options: [
                                                    ...
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'hpd5kixn' /* Distrito Federal */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'buia5gg2' /* Espírito Santo */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'nxwcn5ma' /* Goiás */,
                                                    ...
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '230gkpe4' /* Mato Grosso */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'nglvr6gm' /* Mato Grosso do Sul */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'zzlmnrkm' /* Minas Gerais */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'yheiednp' /* Pará */,
                                                    ...
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '16ger76h' /* Rio  de Janeiro */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'kpy76i1r' /* Rio Grande do Norte */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'i0vd8r9v' /* Rio Grande do Sul */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '6xiruvuq' /* Rondônia */,
                                                            ...
                                                            children: [
                                                              TextSpan(
                                                                text: FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'li0alirm' /* Declaro que li concordo com os... */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
